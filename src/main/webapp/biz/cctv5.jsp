...
<head>
    ...
    <link href="../static/css/cctv5_didiaokan.css" type="text/css" rel="stylesheet">
    <script src="http://c.jrszhibo.com/sj/htmlFontSize.js"></script>
    <script src="../static/react/jquery.min.js" type="text/javascript"></script>
    <script src="../static/biz/cctv5_didiaokan.js" type="text/javascript"></script>
</head>
